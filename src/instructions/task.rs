...
pub fn submit_task(
    ...
    reward_machine.owner = ctx.accounts.owner.key();
...
#[derive(Accounts)]
#[instruction(period: u32, uuid: [u8; 16])]
pub struct SubmitTask<'info> {
    ...
    #[account(
        ...
        bump,
        payer = owner,
        space = 8 + RewardMachine::MAXIMUM_SIZE
    )]
